...
namespace GameFramework.Resource
{
    ...
    {
        private const string RemoteVersionListFileName = ResourceExtensionConfig.RemoteVersionListFileName;
        private const string LocalVersionListFileName = ResourceExtensionConfig.LocalVersionListFileName;
