...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class LocalizationComponentInspector : GameFrameworkInspector
    {
        ...
        private SerializedProperty m_DictionaryType = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                EditorGUILayout.PropertyField(m_DictionaryType);
        ...
        private void OnEnable()
        {
            ...
            m_DictionaryType = serializedObject.FindProperty("m_DictionaryType");
