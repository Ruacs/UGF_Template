...
namespace UnityGameFramework.Editor.ResourceTools
{
    public sealed class ResourcePackBuilderController
    {
        ...
        private const string DefaultExtension = ResourceExtensionConfig.DefaultExtension;
        ...
        public string[] GetVersionNames()
        {
            ...
            foreach (DirectoryInfo directoryInfo in sourceDirectoryInfo.GetDirectories())
            {
                ...
                FileInfo[] versionListFiles = platformDirectoryInfo.GetFiles(ResourceExtensionConfig.RemoteVersionListSearchPattern, SearchOption.TopDirectoryOnly);
        ...
        public bool BuildResourcePack(string sourceVersion, string targetVersion)
        {
            try
            {
                ...
                if (sourceVersion != null)
                {
                    ...
                    FileInfo[] sourceVersionListFiles = sourceDirectoryInfo.GetFiles(ResourceExtensionConfig.RemoteVersionListSearchPattern, SearchOption.TopDirectoryOnly);
                ...
                FileInfo[] targetVersionListFiles = targetDirectoryInfo.GetFiles(ResourceExtensionConfig.RemoteVersionListSearchPattern, SearchOption.TopDirectoryOnly);
